...
![Keil uVision编译](https://github.com/maximlab/modular-2/blob/master/software/screenshot/uvision5_options_output_bin_file.jpg?raw=true)<br>
点击蓝框内的Rebuild，进行编译，最后在项目目录下生成helloworld.bin镜像文件，其他操作参考联机烧录。<br>

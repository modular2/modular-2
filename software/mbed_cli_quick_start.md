...
### Mbed CLI 安装
Windows安装比较简单，直接到官网（https://os.mbed.com/docs/latest/tools/installation-and-setup.html) 下载安装。
下载链接http://mbed-os.s3-eu-west-1.amazonaws.com/builds/Mbed_installer_v0.4.7.exe
### LINUX安装
需要先安装以下工具
